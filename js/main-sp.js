...
function load_highcharts()
{
  ...
  $(document).ready(function () {
    var chart1_opts = {
        ...
        title: {
            text: 'personas con necesidad de ayuda ',
            align : 'left',
            style: {
                color: 'rgb(85,85,85)',
        ...
        series : [{
            name : 'personas con necesidad de ayuda',
            type : "area",
            fillColor : {
  ...
  $(document).ready(function () {
    var chart2_opts = {
        ...
        title: {
            text: 'los requerimientos financieros',
            align : 'left',
            style: {
                color: 'rgb(85,85,85)',
                font: '24px "Open Sans", sans-serif'
        ...
        series : [{
            name : 'los requerimientos financieros',
            type : "area",
            fillColor : {
              linearGradient : [0, 0, 0, 300],
              stops : [
...
$(function() {
  ...
  var manifest=[
    ...
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-p3Hmmkv/0/O/i-p3Hmmkv.jpg", cycle_title: 2010, cycle_desc: "Inundaciones, Pakistán", cycle_credit: "ACNUR/Eduardo Diaz"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-dnqScD3/0/O/i-dnqScD3.jpg", cycle_title: 2013, cycle_desc: "Tifón Haiyan , Filipinas", cycle_credit: "OCHA/Joey Reyna"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-mSWcCTS/0/O/i-mSWcCTS.jpg", cycle_title: 2010, cycle_desc: "Inundaciones, Pakistán", cycle_credit: "Foto ONU/UNICEF/ZAK"},
...
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-Cp7ZprP/0/O/i-Cp7ZprP.jpg", cycle_title: 2010, cycle_desc: "Hurricane Sandy, Haiti", cycle_credit: "MINUSTAH/Logan Abassi"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-PRvSmT2/0/O/i-PRvSmT2.jpg", cycle_title: 2011, cycle_desc: "Inundaciones, Pakistán", cycle_credit: "ACNUR/Eduardo Diaz"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-7Dzrj7p/0/O/i-7Dzrj7p.jpg", cycle_title: 2012, cycle_desc: "Campo de desplazados, Sudan", cycle_credit: "UNAMID/Albert González Farran"},
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-tztwTtQ/0/O/i-tztwTtQ.jpg", cycle_title: 2013, cycle_desc: "Conflict, Syria", cycle_credit: "OCHA/Gemma Connell"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-g5W3Q4t/0/O/i-g5W3Q4t.jpg", cycle_title: 2010, cycle_desc: "Inundaciones, Mali", cycle_credit: "OCHA/Diakaridia Dembélé"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-GT5Wktb/0/O/i-GT5Wktb.jpg", cycle_title: 2013, cycle_desc: "Tifón Haiyan , Filipinas", cycle_credit: "ACNUR/R.Rocamora-Tacloban"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-mf9P2qB/0/O/i-mf9P2qB.jpg", cycle_title: 2013, cycle_desc: "Tifón Haiyan , Filipinas", cycle_credit: "OCHA/Gemma Cortes"},
//i-LK5KMP9
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-LK5KMP9/0/O/i-LK5KMP9.jpg", cycle_title: 2011, cycle_desc: "Campo de refugiados, Kenia", cycle_credit: "OIM/ACNUR/Brendan Bannon"}

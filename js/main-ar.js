  ...
  $(document).ready(function () {
    var chart1_opts = {
        ...
        tooltip : {
          useHTML: true,
          formatter : function () {
            return  '<span style="float: right; font-size: 20px">مليون شخص ' + this.y + '</span>';
          }
        },
        plotOptions : {
          area : {
  ...
  $(document).ready(function () {
    var chart2_opts = {
        ...
        tooltip : {
          useHTML: true, 
          formatter : function () {
            return  '<span style="float: right; font-size: 20px">مليار دولار أمريكي ' + this.y + '</span>';
          }
        },
        plotOptions : {
          area : {
...
$(function() {
  ...
  var manifest=[
    ...
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-p3Hmmkv/0/O/i-p3Hmmkv.jpg", cycle_title: 2010, cycle_desc: "فيضانات،  الباكستان", cycle_credit: "UNHCR/Eduardo Diaz"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-dnqScD3/0/O/i-dnqScD3.jpg", cycle_title: 2013, cycle_desc: "إعصار  هايين،  الفلبين", cycle_credit: "OCHA/Joey Reyna"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-mSWcCTS/0/O/i-mSWcCTS.jpg", cycle_title: 2010, cycle_desc: "فيضانات،  الباكستان", cycle_credit: "UN Photo/UNICEF/ZAK"},
...
//    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-t4cfwqn/0/O/i-t4cfwqn.jpg", cycle_title: 2012, cycle_desc: "Refugee camp, Iraq", cycle_credit: "UNHCR/Jerome Seregni"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-QNJTVDD/0/O/i-QNJTVDD.jpg", cycle_title: 2010, cycle_desc: "مخيم  اللاجئين،  أثيوبيا", cycle_credit: "UN Photo/Eskinder Debebe"},
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-CH5FSpB/0/O/i-CH5FSpB.jpg", cycle_title: 2011, cycle_desc: "Hurricane Sandy, Haiti", cycle_credit: "MINUSTAH/Logan Abassi"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-PCRzLCQ/0/O/i-PCRzLCQ.jpg", cycle_title: 2011, cycle_desc: "فيضانات،  الباكستان", cycle_credit: "UNICEF/Asad Zaidi"},
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-Cp7ZprP/0/O/i-Cp7ZprP.jpg", cycle_title: 2010, cycle_desc: "Hurricane Sandy, Haiti", cycle_credit: "MINUSTAH/Logan Abassi"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-PRvSmT2/0/O/i-PRvSmT2.jpg", cycle_title: 2011, cycle_desc: "فيضانات،  الباكستان", cycle_credit: "UNHCR/Eduardo Diaz"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-7Dzrj7p/0/O/i-7Dzrj7p.jpg", cycle_title: 2012, cycle_desc: "مخيم  نازحين،  السودان", cycle_credit: "UNAMID/Albert González Farran"},
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-tztwTtQ/0/O/i-tztwTtQ.jpg", cycle_title: 2013, cycle_desc: "Conflict, Syria", cycle_credit: "OCHA/Gemma Connell"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-g5W3Q4t/0/O/i-g5W3Q4t.jpg", cycle_title: 2010, cycle_desc: "فيضانات، مالي", cycle_credit: "OCHA/Diakaridia Dembélé"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-GT5Wktb/0/O/i-GT5Wktb.jpg", cycle_title: 2013, cycle_desc: "إعصار  هايين،  الفلبين", cycle_credit: "UNHCR/R.Rocamora-Tacloban"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-mf9P2qB/0/O/i-mf9P2qB.jpg", cycle_title: 2013, cycle_desc: "إعصار  هايين،  الفلبين", cycle_credit: "OCHA/Gemma Cortes"},
//i-LK5KMP9
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-LK5KMP9/0/O/i-LK5KMP9.jpg", cycle_title: 2011, cycle_desc: "مخيم  للاجئين،  كينيا", cycle_credit: "IOM/UNHCR/Brendan Bannon"}

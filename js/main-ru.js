...
$(function() {
	...
	$(".ch-info .ch-info-back, .twitter-logo").each(function(i, item) {
		...
		$(this).bind("click", function() {
			...
			show_text = $(this).find("p").text().replace(/Tweet/i, "");
...
function load_highcharts()
{
  ...
  $(document).ready(function () {
    var chart1_opts = {
        ...
        series : [{
            name : 'Люди, нуждающиеся в помощи',
            type : "area",
            fillColor : {
  ...
  $(document).ready(function () {
    var chart2_opts = {
        ...
        title: {
            text: 'Необходимое финансирование',
            align : 'left',
            style: {
                color: 'rgb(85,85,85)',
                font: '24px "Open Sans", sans-serif'
...
$(function() {
  ...
  var manifest=[
    ...
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-p3Hmmkv/0/O/i-p3Hmmkv.jpg", cycle_title: 2010, cycle_desc: "Наводнение , Пакистан", cycle_credit: "УВКБ ООН/ Эдуардо Диас"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-dnqScD3/0/O/i-dnqScD3.jpg", cycle_title: 2013, cycle_desc: "Тайфун Хайян, Филиппины", cycle_credit: "УКГВ ООН/ Джои Рейна"},
    {id: "#slides-01-07-and-18", src: "http://ocha.smugmug.com/photos/i-mSWcCTS/0/O/i-mSWcCTS.jpg", cycle_title: 2010, cycle_desc: "Наводнение , Пакистан", cycle_credit: "Фотография OOН/ЮНИСЕФ/ZAK"},
...
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-CH5FSpB/0/O/i-CH5FSpB.jpg", cycle_title: 2011, cycle_desc: "Hurricane Sandy, Haiti", cycle_credit: "MINUSTAH/Logan Abassi"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-PCRzLCQ/0/O/i-PCRzLCQ.jpg", cycle_title: 2011, cycle_desc: "Наводнение , Пакистан", cycle_credit: "ЮНИСЕФ/ Асад Заиди"},
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-Cp7ZprP/0/O/i-Cp7ZprP.jpg", cycle_title: 2010, cycle_desc: "Hurricane Sandy, Haiti", cycle_credit: "MINUSTAH/Logan Abassi"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-PRvSmT2/0/O/i-PRvSmT2.jpg", cycle_title: 2011, cycle_desc: "Наводнение , Пакистан", cycle_credit: "УВКБ ООН/ Эдуардо Диас"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-7Dzrj7p/0/O/i-7Dzrj7p.jpg", cycle_title: 2012, cycle_desc: "Лагерь для внутренне перемещенных лиц, Судан", cycle_credit: "ЮНАМИД/ Альберт Гонсалес Фарран"},
//    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-tztwTtQ/0/O/i-tztwTtQ.jpg", cycle_title: 2013, cycle_desc: "Conflict, Syria", cycle_credit: "OCHA/Gemma Connell"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-g5W3Q4t/0/O/i-g5W3Q4t.jpg", cycle_title: 2010, cycle_desc: "Наводнение, Мали", cycle_credit: "УКГВ ООН/ Диакаридиа Дембеле"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-GT5Wktb/0/O/i-GT5Wktb.jpg", cycle_title: 2013, cycle_desc: "Тайфун Хайян, Филиппины", cycle_credit: "УВКБ ООН/Р.Рокамора -Таклобан"},
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-mf9P2qB/0/O/i-mf9P2qB.jpg", cycle_title: 2013, cycle_desc: "Тайфун Хайян, Филиппины", cycle_credit: "УКГВ ООН/ Джемма Кортес"},
//i-LK5KMP9
    {id: "#slides-08-17", src: "http://ocha.smugmug.com/photos/i-LK5KMP9/0/O/i-LK5KMP9.jpg", cycle_title: 2011, cycle_desc: "Лагерь беженцев, Кения", cycle_credit: "МОМ/УВКБ ООН/Брендан Баннон"}
